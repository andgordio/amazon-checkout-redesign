<template>
<div style="position: absolute; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(0,0,0,0.4)">
  <div style="max-width: 800px; margin: 5vh auto; background-color: white; border-radius: 2px; box-shadow: 0px 12px 36px rgba(0,0,0,0.1);">
    <div class="flexy padding-vert-m padding-hor-l" style="height: 7vh; border-bottom: 1px solid silver;">
      <div><h3>Quick Preview</h3></div>
      <div class="fixed" style="width: 16px;" @click="closePressed()"><button>x</button></div>
    </div>
    <div style="max-height: 80vh; overflow: auto;">
       <div class="flexy align-top padding-hor-l padding-vert-l">
        ...
        <div class="padding-hor-l">
          ...
          <div class="padding-vert-s">
            <button class="boxed primary" @click="addPressed()">Add to cart</button>
          </div>
