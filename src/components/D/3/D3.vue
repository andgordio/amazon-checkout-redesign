  ...
  <div style="max-height: 100vh; overflow: auto;">
    ...
    <div class="" style="background-color: #24303D; color: white;">
      ...
      <div id="first" class="flexy" style="height: 60px; position: relative; align-items: flex-start;">
        <div class="fixed padding-hor-l" style="width: 140px; cursor: pointer; padding-top: 12px;" @click="$router.push({name: 'Start2'})">
          <img src="./../../../assets/amazon-logo.png" style="width: 84px;" alt="">
        </div>
        <!-- checkout -->
        <transition name="lineonecheckout">
          <div v-if="$route.name !== 'Start2' && $route.name !== 'ShoppingCart2' && $route.name !== 'Complete2'" style="position: absolute; margin-top: 12px; padding-top: 4px; padding-bottom: 4px; margin-left: 132px; padding-left: 21px; color:#FF9900; font-size: 19px; font-weight: 500; border-left: 1px solid rgba(255,255,255,0.2);">Checkout</div>
        </transition>
        <!--  -->
        <transition name="lineoneinit">
        <div class="flexy padding-hor-m lineoneinit" style="" v-if="$route.name === 'Start2' || $route.name === 'ShoppingCart2' || $route.name === 'Complete2'">
        ...
        <!--  -->
        <transition name="lineoneinit">
        <div class="fixed padding-hor-l flexy align-center lineoneinit" style="width: 140px; cursor: pointer;" v-if="$route.name === 'Start2' || $route.name === 'ShoppingCart2' || $route.name === 'Complete2'" @click="$router.push({name:'ShoppingCart2'})">
      ...
      <div v-if="$route.name === 'Start2' || $route.name === 'ShoppingCart2' || $route.name === 'Complete2'" id="second" class="flexy align-center linetwo-container">
        ...
        <!--  -->
        <div class="fixed padding-hor-l flexy align-center" style="cursor: pointer; font-size: 13px; font-weight: 900;" @click="$route.name = 'ShoppingCart2'">
