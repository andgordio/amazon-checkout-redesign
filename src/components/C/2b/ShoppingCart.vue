      ...
      <div class="padding-vert-l flexy align-top">
        ...
        <div>
          <transition name="cart-appear" appear>
            <div class="padding-vert-m padding-hor-l rounded silver" style="padding: 12px 40px; background-color: white; box-shadow: 0px 7px 24px rgba(0,0,0,0.1);">
              <div style="">
                <h1 style="padding: 24px 0; font-size: 24px; font-weight: 600; border-bottom: 1px solid #EBEEF5;">Shopping Cart</h1> <!---->
              </div>
                ...
                <div class="list-ani-item large" v-for="(item, i) in items" :key="item.name">
                  <div class="padding-vert-m flexy align-top">
                    <div class="fixed overlay-wrapper">
                      <div class="overlay-image"><img :src="item.img" width="75px" style="border-radius: 2px;"></div>
                    ...
                    <div style="padding-right: 24px; padding-top: 4px;">
              ...
              <div class="padding-vert-m flexy" style="padding-top: 24px; padding-bottom: 32px; border-top: 1px solid #EBEEF5;"> <!---->
                <div class="fixed" style="width: 102px;"></div>
            ...
            <div>
              ...
              <transition name="later-fade">
                <div style="padding: 12px 32px;" v-if="later.length > 0">      
                  <div>
                    <h2 style="padding: 32px 0px 24px; font-size: 20px; border-bottom: 1px solid #DDE1EB;">You saved for later</h2> <!-- color: #CACED9;-->
                  </div>
              ...
              <div style="padding: 12px 32px;">      
                <div>
                  <h2 style="padding: 32px 0px 24px; font-size: 20px; border-bottom: 1px solid #DDE1EB;">{{youRecentlyViewed}}</h2> <!-- color: #CACED9;-->
                </div>
                <transition-group name="list-ani" tag="div" class="padding-vert-m flexy" style="flex-wrap: wrap;">
        ...
        <div class="fixed" style="width: 320px; margin-left: 48px;">
          <div class="padding-vert-m padding-hor-xl bordered rounded silver" style="height: 224px; text-align: center;">
            <img src="./../../../assets/prime-logo.png" width="125px" style="padding-top: 56px">
          </div>
          <div>
            <h2 style="padding: 42px 0px 24px; font-size: 20px; border-bottom: 1px solid #DDE1EB;">Customers also bought</h2> <!--color: #CACED9;-->
          </div>
          <div class="">
